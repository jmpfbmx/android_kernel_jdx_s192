	...
	if (panel) {
		...
		if (panel->init_dc_out) {
			...
			if ((mainboard.board_id == BOARD_E1784) ||
				...
				(mainboard.board_id == BOARD_E1780)) {

				ardbeg_disp1_out.rotation = 90;
...
int __init ardbeg_panel_init(void)
{
	...
	gpio_request(67,"vdd_3v3");
	gpio_request(169,"lcd_rest");
#endif
