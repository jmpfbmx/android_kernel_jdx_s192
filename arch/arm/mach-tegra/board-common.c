...
#ifdef CONFIG_THERMAL
	tegra_add_trip_points(trips, num_trips, tegra_sdhci_get_cdev(0));
	tegra_add_trip_points(trips, num_trips, tegra_sdhci_get_cdev(1));
	tegra_add_trip_points(trips, num_trips, tegra_sdhci_get_cdev(2));
#endif
}
