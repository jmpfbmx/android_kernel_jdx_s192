...
static struct tegra12_emc_table ardbeg_emc_table[] = {
		...
		},
		{
			...
			31, 		/* number of up_down_regs */
			{
				...
				0x00000000, /* EMC_DLL_XFORM_QUSE6 */
				0x00000000, /* EMC_DLL_XFORM_QUSE7 */
				0x000a0000, /* EMC_DLL_XFORM_ADDR0 */
				0x000a0000, /* EMC_DLL_XFORM_ADDR1 */
				0x00000000, /* EMC_DLL_XFORM_ADDR2 */
				0x000a0000, /* EMC_DLL_XFORM_ADDR3 */
				0x000a0000, /* EMC_DLL_XFORM_ADDR4 */
				0x00000000, /* EMC_DLL_XFORM_ADDR5 */
				0x00000000, /* EMC_DLL_XFORM_QUSE8 */
				0x00000000, /* EMC_DLL_XFORM_QUSE9 */
				0x00000000, /* EMC_DLL_XFORM_QUSE10 */
		...
		},
		{
			...
			31, 		/* number of up_down_regs */
			{
				...
				0x00000002, /* EMC_DLI_TRIM_TXDQS15 */
				0x0000000e, /* EMC_DLL_XFORM_DQ0 */
				0x0000000e, /* EMC_DLL_XFORM_DQ1 */
				0x0000000e, /* EMC_DLL_XFORM_DQ2 */
				0x0000000e, /* EMC_DLL_XFORM_DQ3 */
...
#else
static struct tegra12_emc_table ardbeg_4GB_emc_table[] = {  //update by holman running shamoo , and 792mhz params need to update
		{
			0x19,		/* V5.0.18 */
			"002_12750_20151116_V5.0.18_V1.1", /* DVFS table version */
			12750,		/* SDRAM frequency */
			800,		/* min voltage */
			800,		/* gpu min voltage */
			"pllp_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_20400_20151116_V5.0.18_V1.1", /* DVFS table version */
			20400,		/* SDRAM frequency */
			800,		/* min voltage */
			800,		/* gpu min voltage */
			"pllp_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_40800_20151116_V5.0.18_V1.1", /* DVFS table version */
			40800,		/* SDRAM frequency */
			800,		/* min voltage */
			800,		/* gpu min voltage */
			"pllp_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_68000_20151116_V5.0.18_V1.1", /* DVFS table version */
			68000,		/* SDRAM frequency */
			800,		/* min voltage */
			800,		/* gpu min voltage */
			"pllp_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_102000_20151116_V5.0.18_V1.1", /* DVFS table version */
			102000, 	/* SDRAM frequency */
			800,		/* min voltage */
			800,		/* gpu min voltage */
			"pllp_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_204000_20151116_V5.0.18_V1.1", /* DVFS table version */
			204000, 	/* SDRAM frequency */
			800,		/* min voltage */
			800,		/* gpu min voltage */
			"pllp_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_300000_20151116_V5.0.18_V1.1", /* DVFS table version */
			300000, 	/* SDRAM frequency */
			820,		/* min voltage */
			820,		/* gpu min voltage */
			"pllc_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_396000_20151116_V5.0.18_V1.1", /* DVFS table version */
			396000, 	/* SDRAM frequency */
			850,		/* min voltage */
			850,		/* gpu min voltage */
			"pllm_out0", /* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_528000_20151116_V5.0.18_V1.1", /* DVFS table version */
			528000, 	/* SDRAM frequency */
			880,		/* min voltage */
			870,		/* gpu min voltage */
			"pllm_ud",	/* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_600000_20151116_V5.0.18_V1.1", /* DVFS table version */
			600000, 	/* SDRAM frequency */
			910,		/* min voltage */
			910,		/* gpu min voltage */
			"pllc_ud",	/* clock source id */
		...
		{
			0x19,		/* V5.0.18 */
			"002_792000_20151116_V5.0.18_V1.1", /* DVFS table version */
			792000, 	/* SDRAM frequency */
			980,		/* min voltage */
			980,		/* gpu min voltage */
			"pllm_ud",	/* clock source id */
			...
			31, 		/* number of up_down_regs */
			{
				...
				0x00000007, /* EMC_DLL_XFORM_DQS14 */
...
int tegra_get_emc_id(void)
{
	union nct_item_type item;
	int err;

	err = tegra_nct_read_item(NCT_ID_EMC_ID, &item);
	if (err < 0)
		return 0;

	return item.emc_id.id;
}
...
int __init ardbeg_emc_init(void)
{
	...
	if (!tegra12_nct_emc_table_init(&board_emc_pdata)) {
		...
		case BOARD_E1782:
			...
			printk("get emmc type , %d\n",tegra_get_memory_type());
			if (tegra_get_emc_id()==0x4) {
				pr_info("Loading Ardbeg 4GB EMC tables.\n");
				tegra_emc_device.dev.platform_data =
					&ardbeg_4GB_emc_pdata;
			} else if (tegra_get_emc_id()==0x2){
				pr_info("Loading Ardbeg 2G EMC tables.\n");
				tegra_emc_device.dev.platform_data =
					&ardbeg_emc_pdata;
			}else{
				pr_info("Loading Default Ardbeg 2G EMC tables.\n");
				tegra_emc_device.dev.platform_data =
					&ardbeg_emc_pdata;
			}
