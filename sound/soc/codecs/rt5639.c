 ...
 */
int rt5639_index_write(struct snd_soc_codec *codec,
...
static const DECLARE_TLV_DB_SCALE(dac_vol_tlv, 0, 375, 0);
		...
		struct snd_ctl_elem_value *ucontrol)
{
	...
	val=0x8;
	val2=0x8;
	snd_soc_write(codec, 0x19, 0xafaf);
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		rt5639_update_eqmode(codec, SPK);
              snd_soc_write(codec, RT5639_DRC_AGC_3, 0x0180);
		snd_soc_write(codec, RT5639_DRC_AGC_2, 0x1fef);
		snd_soc_write(codec, RT5639_DRC_AGC_1, 0x6226);
#endif
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		snd_soc_update_bits(codec,RT5639_PWR_DIG1,
			RT5639_PWR_CLS_D, 0);
		snd_soc_write(codec, RT5639_DRC_AGC_1, 0x2226);
		break;
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		rt5639_pmu_depop(codec);
             snd_soc_write(codec, RT5639_DRC_AGC_1, 0x22a6);
		break;
