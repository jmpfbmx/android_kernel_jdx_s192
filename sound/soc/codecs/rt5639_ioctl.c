...
hweq_t hweq_param[] = {
	...
	{/* SPK */
		...
		{0x1180, 0x0000, 0xdd7d, 0x1496, 0x1830, 0xc882, 0x1c10, 0x01f4,0xe904, 0x1c10, 0x01f4, 0xe904, 0x1c10, 0x01f4, 0x1c10, 0x01f4,0x1e58, 0x016a, 0x1e8d,0x0402,0x0800},
		0x00c3,
	},
	{/* HP */
		...
		{0x1c10, 0x01f4, 0xc5e9, 0x1a98, 0x1d2c, 0xc882, 0x1c10, 0x01f4,
		 ...
		 0x2000, 0x0000, 0x2000,0x0800,0x0800},
		0x0000,
	},
};
	...
	struct snd_soc_codec *codec, int mode)
{
	...
	for (i = 0; i <= EQ_REG_NUM; i++) {
		if (hweq_param[mode].reg[i])
			rt5639_index_write(codec, hweq_param[mode].reg[i],
