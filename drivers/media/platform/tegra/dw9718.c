...
static int dw9718_power_get(struct dw9718_info *info)
{
	...
	dw9718_regulator_get(info, &pw->vdd1, "vdd_cam_1v1_cam");
	dw9718_regulator_get(info, &pw->vdd2, "vdd_lcd_1v2_s");
	dw9718_regulator_get(info, &pw->vdd3, "imx135_reg2");
	dw9718_regulator_get(info, &pw->vdd_i2c, "vdd_2v7_hv");
