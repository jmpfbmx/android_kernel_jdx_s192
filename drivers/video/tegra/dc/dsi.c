...
int tegra_dsi_send_panel_backlight_cmd(int brightness)
{
	struct tegra_dc_dsi_data *dsi;
    struct tegra_dsi_cmd dsi_p_1920x1200_backlight_cmd[] = {
		DSI_CMD_SHORT(0x15, 0x51, 0xe6),
		DSI_DLY_MS(3),
	};
	dsi_p_1920x1200_backlight_cmd->sp_len_dly.sp.data1 = brightness;
	if(s_tegra_dc != NULL){
		dsi = tegra_dc_get_outdata(s_tegra_dc);
		tegra_dsi_send_panel_cmd(s_tegra_dc,dsi,dsi_p_1920x1200_backlight_cmd,ARRAY_SIZE(dsi_p_1920x1200_backlight_cmd));
	}
	return 0;
}
EXPORT_SYMBOL(tegra_dsi_send_panel_backlight_cmd);
