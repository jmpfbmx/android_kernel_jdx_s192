...
static inline void ldousb_voltage(struct tegra_udc *udc, int voltage)
{
#ifdef CONFIG_PALMAS_LDOUSB_INPUT
	palmas_ldousb_in_ldousb_voltage(voltage);
#endif
}
